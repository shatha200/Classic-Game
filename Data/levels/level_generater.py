...
#هذا مش تابع الكود نريقل فيه في les noveau w bara
...
blob_img = pygame.image.load('Data/sprites/Characters/E/1.png')
platform_x_img = pygame.image.load('Data/sprites/Block/x2.png')
platform_y_img = pygame.image.load('Data/sprites/Block/x2.png')
lava_img = pygame.image.load('Data/sprites/Characters/E/lava.png')
coin_img = pygame.image.load('Data/sprites/coin/1.png')
exit_img = pygame.image.load('Data/sprites/exit/1.png')
save_img = pygame.image.load('Data/sprites/butons/save.png')
load_img = pygame.image.load('Data/sprites/butons/load.png')
